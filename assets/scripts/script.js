...
function addProjectHandler(e) {
  ...
  let { projectName, projectDescription, projectDueDate } = formObject;
  ...
  const formattedDate = new Date(projectObject.projectId).toLocaleString();
  console.log(`Project ID (Date and Time): ${formattedDate}`);
...
function displayProject() {
  ...
  const formattedDate = new Date(projectObject.projectId).toLocaleString();
  document.querySelector('.proj-detail__created-date').textContent =
    formattedDate;
